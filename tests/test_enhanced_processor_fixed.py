...
class TestEnhancedArticleProcessorFixed(unittest.TestCase):
    """增强处理器测试类 - 修复版本"""
    ...
    def setUp(self):
        ...
        # 在类级别设置mock，这样在整个测试过程中都有效
        self.patcher = patch('lookonchain.enhanced_processor.OpenAIClientWrapper')
    ...
    def test_process_article_success(self):
        ...
        # 重新创建历史管理器
        self.processor.history_manager = ArticleHistoryManager(self.history_file)
